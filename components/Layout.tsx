          ...
          <div className="max-w-7xl mx-auto px-4 py-2">
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg px-4 py-3 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-red-200 mt-1">{authError}</p>
                <p className="text-xs text-red-300 mt-2">
                  Check browser console (F12) for details or see <a href="/docs/DEBUG_GOOGLE_SIGNIN.md" className="underline">debugging guide</a>
                </p>
              </div>
              <button 
